This project focuses on predicting airline ticket prices using dataset containing flight details such as airline, route, journey date, duration, and number of stops. 
The data was preprocessed by handling missing values, converting and extracting date-time features, encoding categorical variables, and applying feature scaling. 
